...
<div class="dashboard-products">
  ...
  <div class="flex items-center justify-between mt-5">
    ...
    <!-- ADD CATEGORY -->
    <a href="index.php?action=quanlydanhmucsanpham&progess=add" class="flex items-center gap-1 bg-bluebtn text-white font-medium p-2 rounded-lg hover:bg-bluehover transition-all">
          ...
          <tr class="border-b border-gray-200">
            ...
            <td class="px-6 py-4">
              <div class="flex items-center gap-2">
                <a href="?action=quanlydanhmucsanpham&progess=update&id=<?php echo $row['id'] ?>" class="flex items-center justify-center gap-1 bg-bluebtn p-2 rounded-lg text-white hover:bg-bluehover">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                  </svg>
                  Sửa
                </a>
                <button href="?action=quanlydanhmucsanpham&progess=delete&id=<?php echo $row['id'] ?>" class="flex items-center justify-center gap-1 bg-secondary p-2 rounded-lg text-white hover:bg-secondaryhover delete_cate_btn" value="<?= $row['id']; ?>">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
