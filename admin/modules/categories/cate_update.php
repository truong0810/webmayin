...
<div class="dashboard-products">
  ...
  <form action="modules/categories/progess_cate_update.php" method="post">
    <div class="mt-5">
      <?php
      ...
      ?>
        <div class="flex flex-col gap-3">
          ...
          <div class="box-field">
            ...
            <input type="text" name="cate_slug" class="p-[6px] bg-[#f9fafb] border border-gray-400 w-full rounded-md outline-none" placeholder="Please enter slug category..." value="<?php echo $row['slug'] ?>" />
          </div>
        </div>
      <?php } ?>
    </div>
