...
<div class="p-3">
  <div class="bg-[#f9fafb] p-3 flex flex-col gap-4 border-2 border-gray-400 shadow-md h-fit rounded-lg">
    ...
    <?= $page_active_cate ? 'bg-gray-300 text-primary' : 'text-black'; ?>
    ">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
    ...
    <a href="index.php?action=quanlyhangsanxuat" class="flex items-center gap-5 hover:bg-gray-300 hover:text-primary transition-all text-xl p-3 rounded-lg font-semibold <?= $page_active_manu ? 'bg-gray-300 text-primary' : 'text-black'; ?>">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
        <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 21v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21m0 0h4.5V3.545M12.75 21h7.5V10.75M2.25 21h1.5m18 0h-18M2.25 9l4.5-1.636M18.75 3l-1.5.545m0 6.205l3 1m1.5.5l-1.5-.5M6.75 7.364V3h-3v18m3-13.636l10.5-3.819" />
      </svg>
      Hãng sản xuất
    </a>
    <a href="index.php?action=quanlysanpham" class="flex items-center gap-5 hover:bg-gray-300 hover:text-primary transition-all text-xl p-3 rounded-lg font-semibold <?= $page_active_product ? 'bg-gray-300 text-primary' : 'text-black'; ?>">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
        <path stroke-linecap="round" stroke-linejoin="round" d="M9 3.75H6.912a2.25 2.25 0 00-2.15 1.588L2.35 13.177a2.25 2.25 0 00-.1.661V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18v-4.162c0-.224-.034-.447-.1-.661L19.24 5.338a2.25 2.25 0 00-2.15-1.588H15M2.25 13.5h3.86a2.25 2.25 0 012.012 1.244l.256.512a2.25 2.25 0 002.013 1.244h3.218a2.25 2.25 0 002.013-1.244l.256-.512a2.25 2.25 0 012.013-1.244h3.859M12 3v8.25m0 0l-3-3m3 3l3-3" />
      </svg>
      Sản phẩm
    </a>
    <a href="index.php?action=quanlydonhang" class="flex items-center gap-5 hover:bg-gray-300 hover:text-primary transition-all text-xl p-3 rounded-lg font-semibold <?= $page_active_order ? 'bg-gray-300 text-primary' : 'text-black '; ?>">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
        <path stroke-linecap="round" stroke-linejoin="round" d="M21 11.25v8.25a1.5 1.5 0 01-1.5 1.5H5.25a1.5 1.5 0 01-1.5-1.5v-8.25M12 4.875A2.625 2.625 0 109.375 7.5H12m0-2.625V7.5m0-2.625A2.625 2.625 0 1114.625 7.5H12m0 0V21m-8.625-9.75h18c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125h-18c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125z" />
      </svg>
      Đơn hàng
    </a>
    <a href="index.php?action=quanlykhachhang" class="flex items-center gap-5 hover:bg-gray-300 hover:text-primary transition-all text-xl p-3 rounded-lg font-semibold <?= $page_active_user ? 'bg-gray-300 text-primary' : 'text-black '; ?>">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
