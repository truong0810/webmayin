...
<body>
      ...
      <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
         <div class="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 h-[500px] overflow-y-auto hidden-scroll">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
               ...
               <form id="form-signup" class="space-y-4" method="post" action="process_signup.php">
                  <div>
                  ...
                  <div class="password-toggle">
                     ...
                     <div class="password-toggle-handle">
                        <input type="password" name="password" id="password" placeholder="••••••••" class="bg-gray-50 border sm:text-sm rounded-lg block w-full p-2.5 <?= isset($_SESSION['error_password']) ? 'border-red-600 text-red-600 focus:ring-red-600 focus:border-red-600'  : 'border-gray-300 text-gray-900 focus:ring-primary-600 focus:border-primary-600' ?>" value="<?php echo $password; ?>" />
                        <div class="relative">
                        ...
                        <?php if (isset($_SESSION['error_password'])) : ?>
                           <p class="text-red-600 text-xs font-medium"><?= $_SESSION['error_password'] ?></p>
                        <?php endif; ?>
                  ...
                  <button type="submit" class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center uppercase user_signup" name="user_signup">
                     Đăng Ký
                  </button>
   ...
   <script type="text/javascript">
      // document.querySelector('.user_signup').addEventListener('click', function() {
      //    setTimeout(() => {
      //       const labelError = document.querySelector('.password-toggle-handle label.error');
      //       labelError.style.position = "absolute";
      //    }, 100)
      // })
