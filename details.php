                     ...
                     <div class="mt-5 flex flex-col gap-2">
                        ...
                        <div class="flex items-center gap-3">
                           ...
                           <div class="py-2 px-1 border border-primary text-primary rounded-lg">
                              <a class="px-3 py-1 border border-primary rounded-full hover:bg-primary hover:text-white transition-all">
                                 -
                              </a>
                           ...
                           <div>
                              <?php if (!empty($_SESSION['cart'])) { ?>
                                 <a href="process_add_to_cart.php?id=<?= $product_id ?>" name="add_order" class="flex items-center justify-center gap-3 bg-secondary text-white hover:bg-[#c40c00] px-10 py-3 rounded-lg transition-all font-semibold h-[50px] w-[300px]">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                              ...
                              <?php } else { ?>
                                 <p class="flex items-center justify-center gap-3 bg-secondary text-white hover:bg-[#c40c00] px-10 py-3 rounded-lg transition-all font-semibold h-[50px] w-[300px]">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                       <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                                    </svg>
                                    Thêm vào giỏ hàng
