...
<div class="product-list mt-10 w-[1495px] overflow-x-auto flex items-center gap-4 flex-wrap mb-10">
  ...
  ?>
    <div class="product-item border w-[232px] border-graydb rounded-lg">
      <a href="index.php?quanly=chitietsanpham&id=<?= $row['id'] ?>" class="flex items-center justify-center text-center p-[15px_10px_20px_10px]">
      ...
      <div class="mt-5 px-1 text-center">
        <a href="index.php?quanly=chitietsanpham&id=<?= $row['id'] ?>" class="hidden-text text-lg font-semibold hover:text-primary transition-all">
          <?= $row['title'] ?>
        </a>
