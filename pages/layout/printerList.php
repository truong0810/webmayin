  ...
  <div class="heading-pinter flex items-center justify-between mt-5">
    <div class="flex items-center gap-3 bg-white z-10">
      ...
      <div class="flex items-center">
        <a href="#" class="pinter-item-link text-sm text-gray77 font-medium hover:text-primary">Máy In Đa Năng</a>
        <a href="#" class="pinter-item-link text-sm text-gray77 font-medium hover:text-primary">Máy In Màu</a>
        <a href="#" class="pinter-item-link text-sm text-gray77 font-medium hover:text-primary">Máy In Máy In A3</a>
      </div>
    </div>
    <!-- ====Button See All====== -->
